      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#6B6B6B]">Sign in to continue repurposing</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                <label className="text-sm text-[#A8A8A8]">Password</label>
                <a href="/forgot-password" className="text-sm text-[#FF6B4A] hover:underline">
                  Forgot password?
                </a>
              </div>
              <div className="relative">
          ...
          <p className="text-center text-sm text-[#6B6B6B] mt-6">
            ...
            <Link href="/signup" className="text-[#FF6B4A] hover:underline">
              Sign up
            </Link>
          </p>
        </div>
